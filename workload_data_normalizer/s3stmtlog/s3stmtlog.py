...
CREATE TABLE IF NOT EXISTS `STATEMENTS_SUMMARY` (
  `SUMMARY_BEGIN_TIME` timestamp NOT NULL COMMENT 'Begin time of this summary',
  `SUMMARY_END_TIME` timestamp NOT NULL COMMENT 'End time of this summary',
...
def stmt_index_names(index_names):
    return json.dumps(",".join(index_names))
